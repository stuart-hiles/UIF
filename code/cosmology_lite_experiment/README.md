...
This folder contains the Python code for the **UIF cosmology-lite emulator**  
used in the *UIF Companion Experiments* (Experiments I–V).  
It generates the synthetic collapse–return fields, operator sweeps, and
diagnostic figures that appear in the Companion and in **UIF Paper IV**.

All scripts assume the standard UIF repo layout:

- data in `UIF/data/cosmology_lite_experiment/`
- outputs in `UIF/output/cosmology_lite_experiment/`
